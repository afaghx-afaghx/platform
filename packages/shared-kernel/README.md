...
Cross-layer event contracts are owned exclusively by `packages/contracts`.
...
7. Cross-layer schemas, including DomainEvent, remain canonical in `@afaghx/contracts`; this package does not redefine them.
