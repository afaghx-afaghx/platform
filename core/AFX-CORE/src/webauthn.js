...
export const WEBAUTHN_PARAMETERS = Object.freeze({ protocol: 'WebAuthn Level 3', algorithm: 'ES256', curve: 'P-256', residentKey: 'required', userVerification: 'required', attestation: 'none', challengeBytes: 32, challengeTtlMs: CHALLENGE_TTL_MS, maxCredentialIdBytes: 1024 });
