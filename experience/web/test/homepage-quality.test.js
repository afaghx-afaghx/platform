...
try {
  ...
  test('V4 exposes all required ecosystem routes and trust boundary', () => {
    for (const marker of ['Products','Suppliers','Factories','Services & Partners','Business Network','INDUSTRY & MANUFACTURING','PROCUREMENT','GLOBAL TRADE','INTELLIGENCE / AI','TRUST / VERIFICATION','Canonical API','18 primary families','36 categories']) assert.match(html, new RegExp(marker));
