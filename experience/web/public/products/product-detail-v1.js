...
root.innerHTML=`<div class="topbar"><div class="page topbar-inner"><a class="brand" href="../baskets.html" aria-label="AFAGHX"><span class="brand-mark" aria-hidden="true">A</span><span>AFAGHX</span></a><div class="actions"><a class="action" href="../baskets.html">${t("بازگشت به کشف","Back to discovery")}</a><a class="action" href="?id=${encodeURIComponent(id)}&lang=${fa?"en":"fa"}">${t("English","فارسی")}</a></div></div></div><main class="page"><section class="hero"><span class="eyebrow">${t("PRODUCT RUNTIME","PRODUCT RUNTIME")}</span><h1>${t("جزئیات محصول","Product detail")}</h1><p class="lede">${t("این صفحه فقط رکورد معتبر برگرفته از API رسمی AFAGHX را نمایش می‌دهد.","This page renders only an authenticated Product record returned by the canonical AFAGHX API.")}</p><div id="status" class="status" role="status" aria-live="polite"></div></section><article id="card" class="card" aria-live="polite"><div id="meta" class="meta"></div><h2 id="name" class="name"></h2><p id="description" class="description"></p><div class="evidence"><span><strong>${t("منبع:","Source:")}</strong> https://api.afaghx.com/v1/products/{id}</span><span>${t("داده‌های تجاری مانند قیمت و موجودی در این Product projection نمایش داده نمی‌شوند.","Commercial fields such as price and stock are not part of this Product projection.")}</span></div></article></main><footer class="footer"><div class="page">${t("اکوسیستم دیجیتال AFAGHX · شواهد‌محور","AFAGHX Digital Ecosystem · Evidence-first")}</div></footer>`;
