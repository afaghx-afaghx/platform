...
from intelligence.ai_gateway.offline_implementer import OfflineImplementer
...
def build_offline_mission_engine() -> MissionEngine:
    gateway = AIGateway(
        providers={
            "mock": MockProvider(),
            "offline-implementer": OfflineImplementer(),
        ...
        policies={
            ...
            "offline-implementer": ProviderPolicy(
